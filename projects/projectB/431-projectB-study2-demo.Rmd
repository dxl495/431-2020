...
Our model is 6.92 + 0.37 sqrt(sbp1) + 0.0048 age + 0.0029 bmi1 + 0.052 diabetes - 0.119 tobaccoquit + 0.014 tobaccocurrent.

You are welcome to use the `equatiomatic` package to print this equation more nicely if you can get it working. Be sure to use enough digits so that you have at least a couple of significant figures in each coefficient, please.
...
Our equation in the small model is

sqrt(sbp2) = 7.06 + 0.37 sqrt(sbp1) + 0.0041 age - 0.12 tobaccoquit - 0.0041 tobaccocurrent
